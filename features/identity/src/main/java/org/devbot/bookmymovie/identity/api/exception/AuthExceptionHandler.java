package org.devbot.bookmymovie.identity.api.exception;
...
public class AuthExceptionHandler {
    ...
    /**
     * A request carrying a valid signed token has already proved identity, so a blocked
     * account is an authorization failure. Login stays on 401 to avoid disclosing account
